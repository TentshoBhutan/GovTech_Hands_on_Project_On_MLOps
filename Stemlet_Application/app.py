...
with open('Streamlit_rf.pkl', 'rb') as f:
    model = pickle.load(f)
...
if select_option == 'Random Forest':
    model = joblib.load('Streamlit_rf.pkl')
...
lithology = st.text_input('lithology')
